...
const Blog = () => {
    const blogs = [
        { id: 1, title: 'Creating Streamlined Safeguarding Processes with OneRen', image: "src/assets/banner-1.png" },
        { id: 2, title: 'What are your safeguarding responsibilities and how can you manage them?', image: "src/assets/banner-1.png" },
        { id: 3, title: 'Revamping the Membership Model with Triathlon Australia', image: "src/assets/banner-1.png" },
    ]

    return (
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-12' id="fqa">
