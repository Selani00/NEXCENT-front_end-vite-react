                    ...
                    <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:item-center justify-around gap-12'>
                        <div className='space-y-8'>
                            <div className='flex items-center gap-4 '>
                                <img src="src/assets/member.png" alt="" className='w-8' />
                                <div>
                            ...
                            <div className='flex items-center gap-4 '>
                                <img src="src/assets/club.png" alt="" className='w-8' />
                                <div>
                        ...
                        <div className='space-y-8'>
                            <div className='flex items-center gap-4 '>
                                <img src="src/assets/event.png" alt="" className='w-8'/>
                                <div>
                            ...
                            <div className='flex items-center gap-4 '>
                                <img src="src/assets/payment.png" alt="" className='w-8'  />
                                <div>
